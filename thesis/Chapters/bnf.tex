...
\begin{grammar}
  ...
  \alt <package_path> \tn{.} <package_identifier>
\end{grammar}
...
\begin{grammar}
  <newtype_decl> ::= \tn{type} <type> <docstring> <cr> \tn{(}
  <type_decl_list> \tn{)}
\end{grammar}
...
\begin{grammar}
  <atom_declaration> ::= \tn{atom} <atomtype> <header> <optionblock>
\end{grammar}
...
\begin{grammar}
  <optionblock> ::= \tn{option} <opt_cr> \tn{(} <atom_option_list>
  \tn{)}
\end{grammar}
...
\begin{grammar}
  <network_decl> ::= \tn{network} <header> <network_block>
\end{grammar}
...
\begin{grammar}
  <inputs> ::= \tn{in} \tn{(} <input_list> \tn{)} <cr>
  \alt \tn{in} <no_params> <cr>
\end{grammar}

\vs

\begin{grammar}
  <outputs> ::= \tn{out} \tn{(} <output_list> \tn{)} <cr>
  \alt \tn{out} <no_params> <cr>
\end{grammar}
...
\begin{grammar}
  ...
  \alt \tn{?} <type> <ident> <docstring>
  \alt <type> <ident> \tn{default} <constant> <docstring>
\end{grammar}
...
\begin{grammar}
  <controller_stmt> ::= \tn{controller} \tn{$($} <ident> \tn{$)$}
\end{grammar}
...
\begin{grammar}
  <param_ref> ::= \tn{in} \tn{.} <ident>
  \alt \tn{out} \tn{.} <ident>
  \alt <ident> \tn{.} \tn{in} \tn{.} <ident>
  \alt <ident> \tn{.} \tn{out} \tn{.} <ident>
  \alt \tn{(} <component_stmt> \tn{)} \tn{.} \tn{out} \tn{.} <ident>
\end{grammar}
