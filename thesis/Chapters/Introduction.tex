...
The high-level way of parallelizing can generally be described by a very
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{gfx/parallelization.pdf}
  \caption{Copernicus parallelization model}
  \label{fig:lolol}
\end{figure}
...
\begin{figure}[H]  
  \centering
  \includegraphics[width=0.8\textwidth]{gfx/arch.pdf}
  \caption{Copernicus architecture}
  \label{fig:arch}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{Chapters/IntroductionIncludes/example.png}
